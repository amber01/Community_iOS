...
#define LABEL_MARGIN_DEFAULT -10.0f   //左右间隙，原来是5
#define BOTTOM_MARGIN_DEFAULT -5.0f //上下间隙，原来是5
#define FONT_SIZE_DEFAULT 15.0f
#define HORIZONTAL_PADDING_DEFAULT 7.0f
#define VERTICAL_PADDING_DEFAULT 3.0f
#define BACKGROUND_COLOR [UIColor colorWithRed:0.93 green:0.93 blue:0.93 alpha:0.00]//label背景颜色，已改成透明
#define TAG_TEXT_COLOR [UIColor blueColor]  //tag 文字颜色
#define TEXT_SHADOW_COLOR [UIColor whiteColor]
#define TEXT_SHADOW_OFFSET CGSizeMake(0.0f, 1.0f)
#define BORDER_COLOR [UIColor colorWithRed:0.93 green:0.93 blue:0.93 alpha:0.00] //边框颜色，已改为透明色
...
- (id)init
{
    ...
    if (self) {
        ...
        [_label setTextColor:TAG_TEXT_COLOR];
