...
@interface DiscoverTopicViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    int     page;
    float   height;
}
...
@implementation DiscoverTopicViewController
...
- (void)getDiscoverData:(int)pageIndex
{
    ...
    NSDictionary *parameters = @{@"Method":@"ReHuatiQuan",
                                 ...
                                 @"Detail":@[@{@"UserID":isStrEmpty(sharedInfo.user_id) ? @"" : sharedInfo.user_id,
                                               ...
                                               @"FldSort":@"0",
                                               @"FldSortType":@"1",
                                               @"AreaID":isStrEmpty(sharedInfo.city) ? @"" : sharedInfo.city,
                                               @"ClassID":@"0",
                                               @"IsEssence":@"0",
                                               }]};
