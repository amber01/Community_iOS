...
- (instancetype)initWithFrame:(CGRect)frame withPost:(NSString *)post_id
{
	if (self = [super initWithFrame:frame]) {
        ...
        NSString *urlStr = [NSString stringWithFormat:@"%@default.aspx?mobile/appdetail&ID=%@",ROOT_URL,post_id];
        NSString * encodingStr = [urlStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]; //UTF-8转码
